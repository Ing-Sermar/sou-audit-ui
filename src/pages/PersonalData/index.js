...
import PersonalDate from '../../assets/imgs/editar.jpg';
          ...
          <div className="container-fluid">
            ...
            <div className="borda">
              ...
              <span className="fontConteudo">
                <img src={PersonalDate} alt="editar" />
                Pedro Souza
              </span>
            </div>
            <div className="borda">
            ...
            <div className="borda">
              ...
              <span className="fontConteudo">
                <img src={PersonalDate} alt="editar" />
                Rua rua rua, 128 - Apto 26487 - Prédio 1
              </span>
            </div>
            <div className="row">
            ...
            <div className="row colunaDados">
              ...
              <div className="borderColunas-2 col-md-6">
                <p className="fontTituloCont">
                  Nome da Escola de Conclusão do Ensino Médio
                </p>
                <span className="fontConteudoDados">XXX</span>
              </div>
            </div>
            <div className="borda">
              ...
              <span className="fontConteudo">
                Rua rua rua, 198 - Apto 26487 - Prédio 1
              </span>
            </div>
            <div className="row">
              <div className="borderColunas-1 col-md-3">
            ...
            <Row>
              ...
              <Col>
                ...
                >
                  {({ getRootProps, getInputProps }) => (
                    <DragDrop {...getRootProps()}>
                      <Document>Histórico do Ensino Médio</Document>
                      <Text>Arraste para cá ou</Text>
                      <Icon
                        src={
                          JSON.stringify(values.files.history) !== '{}'
                            ? Success
                            : Upload
                        }
                      />
                ...
                >
                  {({ getRootProps, getInputProps }) => (
                    <DragDrop {...getRootProps()}>
                      ...
                      <Icon
                        src={
                          JSON.stringify(values.files.conclusion) !== '{}'
                            ? Success
                            : Upload
                        }
                      />
